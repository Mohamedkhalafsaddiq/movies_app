...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDatailsBloc>()
        ..add(GetMovieDatailsEvent(id))
...
class MovieDetailContent extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDatailsBloc, MovieDatailsState>(
      builder: (context, state) {
        if (state.movieDatailsState == RequistState.loading) {
          return const Center(child: CircularProgressIndicator());
        }
        if (state.movieDatailsState == RequistState.error) {
                  ...
                  child: ShaderMask(
                    ...
                    child: CachedNetworkImage(
                      ...
                      imageUrl: ApiConstance.imageUrl(
                        state.movieDatails!.backdropPath,
                      ),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Text(
                              state.movieDatails!.releaseDate.split('-')[0],
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                (state.movieDatails!.voteAverage / 2)
                                    .toStringAsFixed(1),
                                style: const TextStyle(
                                  fontSize: 16.0,
                                  fontWeight: FontWeight.w500,
                              ...
                              const SizedBox(width: 4.0),
                              Text(
                                '(${state.movieDatails!.voteAverage})',
                                style: const TextStyle(
                                  fontSize: 1.0,
                                  fontWeight: FontWeight.w500,
                                  letterSpacing: 1.2,
                          ...
                          const SizedBox(width: 16.0),
                          Text(
                            _showDuration(state.movieDatails!.runtime),
                            style: const TextStyle(
                      ...
                      const SizedBox(height: 8.0),
                      Text(
                        'Genres: ${_showGenres(state.movieDatails!.genres)}',
                        style: const TextStyle(
                          color: Colors.white70,
                          fontSize: 12.0,
                          fontWeight: FontWeight.w500,
